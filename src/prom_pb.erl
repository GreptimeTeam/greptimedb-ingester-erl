...
-export_type(['promql_request'/0, 'promql_response'/0, 'prom_range_query'/0, 'response_header'/0, 'request_header'/0, 'auth_header'/0, 'basic'/0, 'token'/0, 'affected_rows'/0, 'flight_metadata'/0]).
-type '$msg_name'() :: promql_request | promql_response | prom_range_query | response_header | request_header | auth_header | basic | token | affected_rows | flight_metadata.
-type '$msg'() :: promql_request() | promql_response() | prom_range_query() | response_header() | request_header() | auth_header() | basic() | token() | affected_rows() | flight_metadata().
    ...
    [{{msg, promql_request},
      [#{name => header, fnum => 1, rnum => 2, type => {msg, request_header}, occurrence => optional, opts => []},
       #{name => promql, rnum => 3, fields => [#{name => query, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []}, #{name => range_query, fnum => 3, rnum => 3, type => {msg, prom_range_query}, occurrence => optional, opts => []}],
         opts => []}]},
     {{msg, promql_response}, [#{name => header, fnum => 1, rnum => 2, type => {msg, response_header}, occurrence => optional, opts => []}, #{name => body, fnum => 2, rnum => 3, type => bytes, occurrence => optional, opts => []}]},
     {{msg, prom_range_query},
      [#{name => query, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []},
       #{name => start, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []},
       #{name => 'end', fnum => 3, rnum => 4, type => string, occurrence => optional, opts => []},
       #{name => step, fnum => 4, rnum => 5, type => string, occurrence => optional, opts => []}]},
     {{msg, response_header}, []},
     {{msg, request_header},
...
get_msg_names() -> [promql_request, promql_response, prom_range_query, response_header, request_header, auth_header, basic, token, affected_rows, flight_metadata].


get_group_names() -> [].


get_msg_or_group_names() -> [promql_request, promql_response, prom_range_query, response_header, request_header, auth_header, basic, token, affected_rows, flight_metadata].
...
find_msg_def(promql_request) ->
    [#{name => header, fnum => 1, rnum => 2, type => {msg, request_header}, occurrence => optional, opts => []},
     #{name => promql, rnum => 3, fields => [#{name => query, fnum => 2, rnum => 3, type => string, occurrence => optional, opts => []}, #{name => range_query, fnum => 3, rnum => 3, type => {msg, prom_range_query}, occurrence => optional, opts => []}],
       opts => []}];
find_msg_def(promql_response) -> [#{name => header, fnum => 1, rnum => 2, type => {msg, response_header}, occurrence => optional, opts => []}, #{name => body, fnum => 2, rnum => 3, type => bytes, occurrence => optional, opts => []}];
...
get_service_names() -> ['greptime.v1.PrometheusGateway'].
...
get_all_source_basenames() -> ["prom.proto", "common.proto"].
...
%% functions.
get_all_proto_names() -> ["prom", "common"].
...
get_protos_by_pkg_name_as_fqbin(<<"greptime.v1">>) -> ["common", "prom"];
