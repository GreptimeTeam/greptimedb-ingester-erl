...
-export_type(['ddl_request'/0, 'create_table_expr'/0, 'alter_expr'/0, 'drop_table_expr'/0, 'flush_table_expr'/0, 'create_database_expr'/0, 'add_columns'/0, 'drop_columns'/0, 'rename_table'/0, 'add_column'/0, 'drop_column'/0, 'table_id'/0, 'values'/0, 'column'/0, 'column_def'/0]).
-type '$msg_name'() :: ddl_request | create_table_expr | alter_expr | drop_table_expr | flush_table_expr | create_database_expr | add_columns | drop_columns | rename_table | add_column | drop_column | table_id | values | column | column_def.
-type '$msg'() :: ddl_request() | create_table_expr() | alter_expr() | drop_table_expr() | flush_table_expr() | create_database_expr() | add_columns() | drop_columns() | rename_table() | add_column() | drop_column() | table_id() | values() | column() | column_def().
...
get_msg_names() -> [ddl_request, create_table_expr, alter_expr, drop_table_expr, flush_table_expr, create_database_expr, add_columns, drop_columns, rename_table, add_column, drop_column, table_id, values, column, column_def].


get_group_names() -> [].


get_msg_or_group_names() -> [ddl_request, create_table_expr, alter_expr, drop_table_expr, flush_table_expr, create_database_expr, add_columns, drop_columns, rename_table, add_column, drop_column, table_id, values, column, column_def].
...
get_all_source_basenames() -> ["ddl.proto", "column.proto"].
...
%% functions.
get_all_proto_names() -> ["ddl", "column"].
...
get_protos_by_pkg_name_as_fqbin(<<"greptime.v1">>) -> ["column", "ddl"];
