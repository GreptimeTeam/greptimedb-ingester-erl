...
-export_type(['ddl_request'/0, 'create_table_expr'/0, 'alter_expr'/0, 'drop_table_expr'/0, 'create_database_expr'/0, 'truncate_table_expr'/0, 'add_columns'/0, 'drop_columns'/0, 'rename_table'/0, 'add_column'/0, 'drop_column'/0, 'table_id'/0, 'column_def'/0, 'add_column_location'/0, 'request_header'/0, 'response_header'/0, 'status'/0, 'auth_header'/0, 'basic'/0, 'token'/0, 'affected_rows'/0, 'flight_metadata'/0, 'interval_month_day_nano'/0, 'decimal_128'/0, 'column_data_type_extension'/0, 'decimal_type_extension'/0]).
-type '$msg_name'() :: ddl_request | create_table_expr | alter_expr | drop_table_expr | create_database_expr | truncate_table_expr | add_columns | drop_columns | rename_table | add_column | drop_column | table_id | column_def | add_column_location | request_header | response_header | status | auth_header | basic | token | affected_rows | flight_metadata | interval_month_day_nano | decimal_128 | column_data_type_extension | decimal_type_extension.
-type '$msg'() :: ddl_request() | create_table_expr() | alter_expr() | drop_table_expr() | create_database_expr() | truncate_table_expr() | add_columns() | drop_columns() | rename_table() | add_column() | drop_column() | table_id() | column_def() | add_column_location() | request_header() | response_header() | status() | auth_header() | basic() | token() | affected_rows() | flight_metadata() | interval_month_day_nano() | decimal_128() | column_data_type_extension() | decimal_type_extension().
